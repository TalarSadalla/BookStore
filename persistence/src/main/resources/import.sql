...
insert into user (id, user_name, password) values (3, 'talar', 'password');
insert into user (id, user_name, password) values (4, 'marcin', 'marcin');
insert into user (id, user_name, password) values (5, 'adam', 'password0!');